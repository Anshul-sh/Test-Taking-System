...
class Subject(models.Model):
    ...
    def __str__(self):
        return self.Subject + " (" + self.Course.Course + ")"
...
class Teacher(models.Model):
    ...
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now_add=True)
    #fcm_token=models.TextField(default="",null=True)
...
class Progress(models.Model):
    ...
    """
    user = models.OneToOneField(UserManager, verbose_name=_("User"), on_delete=models.CASCADE)
    ...
    def list_all_cat_scores(self):
        ...
        for cat in Course.objects.all():
            to_find = re.escape(cat.Course) + r",(\d+),(\d+),"
    ...
    def update_score(self, question, score_to_add=0, possible_to_add=0):
        ...
        """
        Course_test = Course.objects.filter(Course=question.Course)\
                                        .exists()
        ...
        if any([item is False for item in [Course_test,
            ...
            return _("error"), _("Course does not exist or invalid score")
...
class Sitting(models.Model):
    ...
    user = models.ForeignKey(UserManager, verbose_name=_("User"), on_delete=models.CASCADE)
