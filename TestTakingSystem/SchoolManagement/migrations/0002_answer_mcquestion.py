...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='MCQuestion',
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='SchoolManagement.question')),
            ...
            bases=('SchoolManagement.question',),
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.mcquestion', verbose_name='Question')),
            ],
            options={
                'verbose_name': 'Answer',
