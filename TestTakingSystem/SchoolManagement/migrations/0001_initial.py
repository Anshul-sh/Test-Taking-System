    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='SchoolManagement.courses')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth', models.DateField(verbose_name='date of birth')),
                ('profile_pic', models.FileField(upload_to=SchoolManagement.models.content_file_name)),
                ('address', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('fcm_token', models.TextField(default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optionA', models.CharField(max_length=300, verbose_name='Aoption')),
                ('optionB', models.CharField(max_length=300, verbose_name='Boption')),
                ('optionC', models.CharField(max_length=300, verbose_name='Coption')),
                ('optionD', models.CharField(max_length=300, verbose_name='Doption')),
                ('answer', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C'), ('D', 'D')], max_length=10, verbose_name='answer')),
                ('level', models.CharField(choices=[('3', 'difficult'), ('1', 'easy'), ('2', 'general')], max_length=10, verbose_name='level')),
                ('score', models.IntegerField(default=1, verbose_name='score')),
                ('subject', models.ManyToManyField(to='SchoolManagement.Subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.subject')),
            ],
            options={
