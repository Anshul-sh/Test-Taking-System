    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course', models.CharField(blank=True, max_length=250, null=True, unique=True, verbose_name='Course')),
            ],
            options={
                'verbose_name': 'Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.course', verbose_name='Course')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='SchoolManagement.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.quiz', verbose_name='Quiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.course', verbose_name='Course')),
                ('Subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='SchoolManagement.subject', verbose_name='Subject')),
                ('quiz', models.ManyToManyField(blank=True, to='SchoolManagement.Quiz', verbose_name='Quiz')),
            ],
            options={
